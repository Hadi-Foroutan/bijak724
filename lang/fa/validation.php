...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'sender_id' => 'فرستنده',
        'sender_address_id' => 'آدرس فرستنده',
        'receiver_id' => 'گیرنده',
        'receiver_address_id' => 'آدرس گیرنده',
        'driver1_id' => 'راننده اول',
        'driver2_id' => 'راننده دوم',
        'referral_driver_id' => 'راننده حواله',
        'fleet_id' => 'ناوگان',
        'referral_weight' => 'وزن حواله',
        'quantity' => 'تعداد',
        'loading_started_at' => 'زمان شروع بارگیری',
        'loading_ended_at' => 'زمان پایان بارگیری',
        'referral_number' => 'شماره حواله',
        'bijak_number' => 'شماره بیجک',
        'serial_number' => 'شماره سریال',
        'company_id' => 'شرکت',
        'company_name' => 'نام شرکت',
        'created_at_from' => 'تاریخ ایجاد از',
        'created_at_to' => 'تاریخ ایجاد تا',
        'bijak_tracking_code' => 'کد رهگیری بیجک',
        'paginate' => 'صفحه‌بندی',
        'itemsPerPage' => 'تعداد در صفحه',
        'per_page' => 'تعداد در صفحه',
        'order_field' => 'ستون مرتب‌سازی',
        'order_type' => 'نوع مرتب‌سازی',
        'issued_at' => 'زمان صدور',
        'liability_insurance' => 'بیمه مسئولیت',
        'insurance_id' => 'بیمه',
        'cargo_group_id' => 'گروه محموله',
        'cargo_value_from' => 'حداقل ارزش محموله',
        'cargo_value_to' => 'حداکثر ارزش محموله',
        'fixed_premium' => 'مبلغ ثابت حق بیمه',
        'premium_percentage' => 'درصد حق بیمه',
        'excess_amount' => 'مبلغ مازاد',
        'transport_contract_id' => 'قرارداد حمل',
        'base_freight_amount' => 'مبلغ کرایه پایه',
        'advance_freight_amount' => 'مبلغ پیش‌کرایه',
        'weighbridge_amount' => 'مبلغ باسکول',
        'loading_amount' => 'مبلغ بارگیری',
        'warehousing_amount' => 'مبلغ انبارداری',
        'commission_amount' => 'مبلغ کمیسیون',
        'insurance_amount' => 'مبلغ بیمه',
        'insurance_tax_amount' => 'مالیات بیمه',
        'detention_amount' => 'مبلغ حق توقف',
        'driver_receivable_amount' => 'مبلغ دریافتی از راننده',
        'payable_amount' => 'مبلغ قابل پرداخت',
        'freight_at_origin' => 'پرداخت کرایه در مبدأ',
        'is_fixed' => 'ثابت بودن مبلغ',
        'cargos' => 'محموله‌ها',
        'cargos.*.cargo_id' => 'کد محموله',
        'cargos.*.id' => 'کد محموله',
        'cargos.*.packaging_id' => 'کد دسته‌بندی',
        ...
        'cargos.*.is_returned' => 'برگشتی بودن محموله',
        'cargos.*.cottage_number' => 'شماره کوتاژ محموله',
        'cargos.*.cottage_number_2' => 'شماره کوتاژ دوم محموله',
